...
**참고**: 스냅샷이 먼저 내려온 뒤 실시간 체결 현황이 수신됨을 알 수 있습니다. 위의 모든 요청은 WebSocket이 정상적으로 연결되었다는 전제로 가정합니다.

---

*원본 문서: [빗썸 API 레퍼런스 - 테스트 및 요청 예제](https://apidocs.bithumb.com/v2.1.5/reference/테스트-및-요청-예제)*
