...
- [인증 헤더 만들기](https://apidocs.bithumb.com/docs/인증-헤더-만들기)를 확인하시기 바랍니다.
...
연결이 완료되면 웹소켓 서버에 다양한 요청을 할 수 있습니다. 요청과 응답은 JSON Object를 이용합니다.
...
자세한 요청 방법은 [타입별 요청 및 응답](https://apidocs.bithumb.com/v2.1.5/reference/현재가-ticker)을 확인하시길 바랍니다.

**참고**: `is_only_snapshot`, `is_only_realtime` 필드는 생략 가능하며 모두 생략할 경우 스냅샷과 실시간 데이터 둘 다 수신합니다.
...
*원본 문서: [빗썸 API 레퍼런스 - 요청 방법 및 포맷](https://apidocs.bithumb.com/v2.1.5/reference/요청-포맷)*
